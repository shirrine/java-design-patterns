/*
 *  Flyweight concept: Rather than creating a new engine object for each request, reuse an
 *  existing engine that has the exact same state. This reduces the number of objects stored in memory.
 */
